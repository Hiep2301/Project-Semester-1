...
// void MainMenu()
// {
//     string[] menu = { "Add product", "Search product by name", "Search product by id", "Display all products", "Update product information", "Delete product", "Exit" };
//     string name = "Products Management System";
//     int choice;
//     do
//     {
